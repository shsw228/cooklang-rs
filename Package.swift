...
var package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/shsw228/cooklang-rs/releases/download/v0.18.6-patched/CooklangParserFFI.xcframework.zip",
            checksum: "d37a0e0d0969bb3934abc81d3df1033eef7db5e7a3d1f928e8144d43b63db2e7"),
    ]
)
